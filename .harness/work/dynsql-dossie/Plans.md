...
- files: `plsqlflow/dynsite.py`, `tests/test_dynsite_categoria.py`, `tests/fixtures/dynsite_formas.json`, `AGENTS.md`, `.harness/work/dynsql-dossie/Plans.md`
...
- files: `plsqlflow/dynsite_template.py`, `tests/test_dynsite_travessia.py`, `docs/backlog-sql-dinamico-estatico.md`
